...
import { ChevronDown, ChevronRight, Circle, FileIcon } from "lucide-react";
...
function File({
  ...
  return (
    <NodeButton
      ...
      icon={
        <FileIcon
          className={cn("scale-98 shrink-0", {
    ...
    >
      ...
      >
        ...
        {unsavedChanges && (
          <Circle className="w-4 h-4 scale-68 shrink-0 text-orange-500" />
        )}
      </div>
    </NodeButton>
  );
