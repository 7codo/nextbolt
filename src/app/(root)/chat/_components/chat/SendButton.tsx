...
import { ChevronRightCircleIcon, CircleStopIcon } from "lucide-react";
      ...
      {show ? (
        ...
        >
          <div className="text-lg">
            {!isStreaming ? (
              <ChevronRightCircleIcon className="text-white h-4 w-4" />
            ) : (
              <CircleStopIcon className="text-white h-4 w-4" />
            )}
          </div>
        </motion.button>
      ) : null}
